...
class NaverSummaryResponseTest {
    ...
    @Test
    void 네이버요약테스트() {
        String message = "일반적으로 충치 예방을 위해 칫솔질을 꼼꼼히 해야 했지만, 이러한 노력에도 불구하고 때로는 불가피한 상황이 발생하기도 합니다. 식습관이나 유전적 요인, 환경적 요소에 따라 상황이 종종 발생할 수 있습니다. 많은 충치가 발생한다면 치아의 표면 상태가 심각한 상황이 많습니다. 또한 침의 분비가 적고 점도가 높은 특징도 있습니다.\n" +
