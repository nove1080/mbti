...
public class PromptTemplate {
    ...
    private static final String START_PROMPT_MESSAGE = "너는 제주도 여행코스를 추천해주는 AI야. " +
    ...
    private static final String RE_START_PROMPT_MESSAGE = "너는 제주도 여행코스를 추천해주는 AI야. " +
    ...
    static public String recommendSpot(String message, int count) {

        return START_PROMPT_MESSAGE + message +
                END_PROMPT_MESSAGE_1 + count + END_PROMPT_MESSAGE_2;
    }

    static public String reRecommendSpot(String chatMessage,String distasteSpot,int count) {

        return RE_START_PROMPT_MESSAGE + chatMessage +
                RE_END_PROMPT_MESSAGE_0 + distasteSpot + RE_END_PROMPT_MESSAGE_1 + count +RE_END_PROMPT_MESSAGE_2
                + RE_END_PROMPT_MESSAGE_3;
    }

    static public String messageAfterGptChange(String spots) {
